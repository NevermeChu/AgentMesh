...
## P-060 codex rollout 压缩归档（.jsonl.zst）暂无法解码，崩溃抢救覆盖 7 天内未压缩会话

**问题**：崩溃抢救读取 ~/.codex/sessions/ 下的 rollout 文件时，超过 7 天被 codex 后台压缩为 .jsonl.zst 的会话无法解析，抢救范围只覆盖未压缩的 JSONL。
